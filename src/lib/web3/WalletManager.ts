  ...
  async getWalletById(walletId: string): Promise<Wallet | null> {
    try {
      ...
      return {
        ...
        signers: data.owners,
        requiredConfirmations: data.threshold,
      };
    } catch (error: any) {
  ...
  async sendTransaction(
    ...
    try {
      ...
      const txData = {
        ...
        data: transaction.data ? { data: transaction.data } : null,
        gas_limit: transaction.gasLimit ? parseInt(transaction.gasLimit) : null,
        gas_price: transaction.gasPrice ? parseInt(transaction.gasPrice) : null,
        nonce: transaction.nonce,
        chain_id: transaction.chainId ? transaction.chainId.toString() : null,
      };
